...
public static List<List<Integer>> generatelist_subset_duplicates(int[] a){
    List<List<Integer>> outer = new   ArrayList<>();
    Arrays.sort(a);
    outer.add(new ArrayList<>());
    int end = 0;
    ...
    public static void main(String[] args) {
        ...
        // generateSubsets(a, result);
        System.out.println(generatelist_subset_duplicates(new int[] {1,2,2}));
    }
